...
import com.feytuo.chat.utils.UserUtils;
...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.rl_switch_block_groupmsg){ // 屏蔽群组
