...
import com.feytuo.bageshuo.util.FindOrientations.Orientation;

public class FindCardContainer extends AdapterView<ListAdapter> {
	private static int position = 0;// 当布局切换到下一个的时候，数目+1；
	...
	public FindCardContainer(Context context) {
		super(context);
	...
	public FindCardContainer(Context context, AttributeSet attrs) {
		super(context, attrs);
		initFromXml(attrs);
		init();
	}

	public FindCardContainer(Context context, AttributeSet attrs, int defStyle) {
	...
	private class GestureListener extends SimpleOnGestureListener {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			if (Math.abs(dx) > mTouchSlop) {
				...
				Log.i(TAG, mTopCard + "GestureListener");
