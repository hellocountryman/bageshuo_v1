...
package com.feytuo.bageshuo.model;
...
public class FindCardModel {
	...
	public FindCardModel() {
		this(null, null, (Drawable)null);
	}

	public FindCardModel(String title, String description, Drawable cardImage) {
		this.title = title;
		this.description = description;
		this.cardImageDrawable = cardImage;
	}

	public FindCardModel(String title, String description, Bitmap cardImage) {
		this.title = title;
		this.description = description;
